...
const awardDefinitions = [
  {
    ...
    description:
      "Metiste al menos 1 entrenamiento de strength por semana durante 3 semanas consecutivas.",
    scope: "profile",
    pointsBonus: 0,
  ...
  },
  {
    ...
    description:
      "Metiste al menos 1 entrenamiento de strength por semana durante 5 semanas consecutivas.",
    scope: "profile",
    pointsBonus: 0,
    iconKey: "el-persistente",
    category: "consistency",
  ...
  },
  {
    ...
    description:
      "Metiste al menos 1 entrenamiento de strength por semana durante 8 semanas consecutivas.",
    scope: "profile",
    pointsBonus: 0,
    iconKey: "el-persistente",
    category: "consistency",
